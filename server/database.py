...
class UserBalance(db.Model):
    ...
    user_flag = db.Column(db.String(80), nullable=False)
    username = db.Column(db.String(80), nullable=False)
    exchange = db.Column(db.String(80), nullable=False)
    balance = db.Column(db.Float, nullable=False)
    balance_update_time = db.Column(db.String(80), nullable=False)
    balance_update_timestamp = db.Column(db.Integer, nullable=False)
